...
for i in mopl:
    if math.sqrt(i)%1 == 0:
        moplnew.append(int(math.sqrt(i)))
print('moplnew',moplnew)
...
for key in dict_days:
    if spisok_dat[0] == key:
        spisok_dat[0] = dict_days[key]
for key in dict_months:
    if spisok_dat[1] == key:
        spisok_dat[1] = dict_months[key]

answer = spisok_dat[0]+' '+spisok_dat[1]+' '+spisok_dat[2]+' '
print (answer)
